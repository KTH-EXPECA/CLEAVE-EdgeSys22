...
\begin{enumerate}
    ...
    \item Values associated to sensors and actuators can be represented by integers, floating point numbers, booleans, or arrays of bytes.
    \item A plant has zero or more sensors attached to it, with potentially different sampling rates.
    \item A plant has zero or more actuators attached to.
\end{enumerate}
