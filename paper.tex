...
\usepackage{xcolor}
\usepackage[detect-weight=true,detect-family=true,binary-units=true,list-units=single]{siunitx}
...
% affiliations
\author{
  \IEEEauthorblockN{Manuel {Olguín Muñoz}}
  \IEEEauthorblockA{
