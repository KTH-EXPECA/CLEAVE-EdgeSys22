...
\todo[inline, caption={}]{
    \begin{itemize}
        ...
        \item try to shorten the discussion around NCS. It is fine that you introduce it, but you don't need the extensive discussion. Likewise, for the experimental NCS works and the simulation works, you can package all that into a single paragraph, where your intent it simply to point out how people typically work in this domain. Then discuss the downsides, and lead over to mreo scalable and repeatable frameworks, i.e., NCSbench. Keep that discussion short and work out more strongly that it still heavily relies on the physical plant hardware (you just speak of hardware) being operated. The rest of the intro is fine.
    \end{itemize}

    CHANGE: removed 5Hz and 100ms cases from plots.
}
