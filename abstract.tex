\begin{abstract}
    \acfp*{NCS} have long been a subject of both theoretical and experimental research. 
    However, the inter-domain nature of such systems has led to a number of task-specific approaches to experimental research, with little work devoted to generalizable, repeatable, and scalable experimentation.
