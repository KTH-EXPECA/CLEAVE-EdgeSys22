\begin{abstract}
    ...
    Although designed for single-loop emulations, the flexibility afforded by the aformentioned characteristics allow our framework to be adapted to a multitude of complex scenarios.
