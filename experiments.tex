...
We detail our experimental edge setup in \cref{fig:cleave:expsetup}.
...
Toppled plants were identified simply by analysis of the emulation data, indentifying instances whose pendulum angles reached values above a threshold value\footnote{This value depends on the parametrization of the controller; in this case it corresponds to \SI{0.35}{\radian}.}.
