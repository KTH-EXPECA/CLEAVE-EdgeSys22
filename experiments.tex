...
\todo[inline]{Explain criteria for repeated experiments? Or just drop this sentence?}
...
These results stem from the contention for network resources, and hints at important trade-offs system designers will have to take into consideration when designing and developing \acl{NCS} for deployment on the edge.
The edge will be \emph{multi-tenant} and \emph{multi-instance}, and thus any edge \ac{NCS} deployment will have to be designed with shared resources in mind.
